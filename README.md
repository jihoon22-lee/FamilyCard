...
Phase 2 진행 중입니다. 코드와 로컬 통합 검증은 끝났고, **실기기 허용 목록·개인정보
canary·실제 원문 수집이 남았습니다.** 현재 상태와 다음 할 일은
...
- 안드로이드 앱은 실기기에서 확인한 exact 허용 목록만 캡처합니다. 현재 개발 빌드의
  운영 목록은 비어 있어 값을 확인하기 전에는 아무 알림도 저장하지 않습니다
